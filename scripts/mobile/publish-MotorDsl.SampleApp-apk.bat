...
REM ============================================================
REM  MotorDsl.SampleApp -- Genera bundle APK de MotorDsl.SampleApp (Release)
REM
REM  Uso:
REM    scripts\mobil\publish-sampleapp-apk.bat
REM    scripts\mobil\publish-sampleapp-apk.bat http://192.168.0.10:5000
REM
...
set "MOBILE_PROJECT=%PROJECT_ROOT%\samples\MotorDsl.SampleApp\MotorDsl.SampleApp.csproj"
set "CONFIG_JSON=%PROJECT_ROOT%\samples\MotorDsl.SampleApp\Resources\Raw\motordsl-config.json"
set "ANDROID_SDK=C:\Program Files (x86)\Android\android-sdk"
set "OUT_DIR=%PROJECT_ROOT%\out\mobile"
set "OUT_APK=%PROJECT_ROOT%\out\mobile\MotorDsl.SampleApp.apk"

echo.
echo ============================================================
echo   MotorDsl.SampleApp -- Publish APK (Release)
echo ============================================================
echo.
