...
> **⚠️ Documento histórico — versión 1.0.** Para la versión actual con los nuevos paquetes (`MotorDsl.Printing.Abstractions`, `MotorDsl.Bluetooth`, `MotorDsl.Maui`) ver [extensibilidad-motor_v1.1.md](./extensibilidad-motor_v1.1.md).
