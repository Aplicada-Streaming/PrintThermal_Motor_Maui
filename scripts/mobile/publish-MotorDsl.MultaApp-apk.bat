...
REM ============================================================
REM MotorDsl.MultaApp -- Genera bundle APK de MotorDsl.MultaApp (Release)
REM
REM  Uso:
REM    scripts\mobil\publish-multaapp-apk.bat
REM    scripts\mobil\publish-multaapp-apk.bat http://192.168.0.10:5000
REM
...
set "MOBILE_PROJECT=%PROJECT_ROOT%\samples\MotorDsl.MultaApp\MotorDsl.MultaApp.csproj"
set "CONFIG_JSON=%PROJECT_ROOT%\samples\MotorDsl.MultaApp\Resources\Raw\motordsl-config.json"
set "ANDROID_SDK=C:\Program Files (x86)\Android\android-sdk"
set "OUT_DIR=%PROJECT_ROOT%\out\mobile"
set "OUT_APK=%PROJECT_ROOT%\out\mobile\MotorDsl.MultaApp.apk"

echo.
echo ============================================================
echo   MotorDsl.MultaApp -- Publish APK (Release)
echo ============================================================
echo.
...
if %ERRORLEVEL% neq 0 (
    echo ERROR: Fallo el clean de MotorDsl.MultaApp
    goto :error
)
...
REM ------------------------------------------------------------
REM  Localizar el APK firmado y copiarlo a out\MotorDsl.MultaApp.apk
REM ------------------------------------------------------------
