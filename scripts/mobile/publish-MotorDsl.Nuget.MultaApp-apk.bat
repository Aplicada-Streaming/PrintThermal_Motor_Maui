...
REM ============================================================
REM  MotorDsl.Nuget.MultaApp -- Genera bundle APK de MotorDsl.Nuget.MultaApp (Release)
REM
REM  Uso:
REM    scripts\mobile\publish-MotorDsl.Nuget.MultaApp-apk.bat
REM    scripts\mobile\publish-MotorDsl.Nuget.MultaApp-apk.bat http://192.168.0.10:5000
REM
...
set "MOBILE_PROJECT=%PROJECT_ROOT%\samples\MotorDsl.Nuget.MultaApp\MotorDsl.Nuget.MultaApp.csproj"
set "CONFIG_JSON=%PROJECT_ROOT%\samples\MotorDsl.Nuget.MultaApp\Resources\Raw\motordsl-config.json"
set "ANDROID_SDK=C:\Program Files (x86)\Android\android-sdk"
set "OUT_DIR=%PROJECT_ROOT%\out\mobile"
set "OUT_APK=%PROJECT_ROOT%\out\mobile\MotorDsl.Nuget.MultaAppt.apk"

echo.
echo ============================================================
echo   MotorDsl.Nuget.MultaApp -- Publish APK (Release)
echo ============================================================
echo.
...
if %ERRORLEVEL% neq 0 (
    echo ERROR: Fallo el clean de MotorDsl.MultaApp.Nuget
    goto :error
)
