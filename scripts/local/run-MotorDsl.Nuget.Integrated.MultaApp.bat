@echo off
echo Lanzando MotorDsl.Nuget.Integrated.MultaApp en dispositivo Android...

cd ..\..

set PROJECT_PATH=samples\MotorDsl.Nuget.Integrated.MultaApp\MotorDsl.Nuget.Integrated.MultaApp.csproj
